...
#define CONFIG_CPUTHREAD
#ifdef CONFIG_CPUTHREAD
pthread_spinlock_t exclusive_lock ;
pthread_spinlock_t gen_opc_lock;
pthread_spinlock_t tb_lock;
...
#ifdef CONFIG_CPUTHREAD
/*
void qemu_exclusive_access(CPUArchState *me){
...
#define CONFIG_CPUTHREAD
#ifdef CONFIG_CPUTHREAD
 pthread_spin_init(&exclusive_lock,0);
//pthread_spin_init(&tb_lock,0); 
pthread_spin_lock(&gen_opc_lock);
...
#define CONFIG_CPUTHREAD
#ifdef CONFIG_CPUTHREAD
    pthread_spin_unlock(&gen_opc_lock);
#endif
