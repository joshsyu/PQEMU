...
#define CONFIG_CPUTHREAD
#ifdef CONFIG_CPUTHREAD
  extern pthread_spinlock_t exclusive_lock;
  extern pthread_spinlock_t gen_opc_lock;
  extern pthread_spinlock_t tb_lock;
  extern volatile sig_atomic_t exclusive_mode;
  void qemu_exclusvie_access(CPUArchState *me);
